...
import com.arkeup.lencify.gestion_brevets_mcs.commun.beanutils.BeanHelper;
...
public class LoggerAspect {
	...
	/**
	 *
	 * Aspect de log execute au debut et a la fin de chaque methode declaree dans le
	 * grefon @Around
	 * 
	 * @param pjp
	 * @return
	 * @throws Throwable
	 */
	@Around("execution(public * com.arkeup.lencify.gestion_brevets_mcs.service..*.*(..))")
...
//		message.append(extraireRetourMethode(objet,loggerSlf));
	...
	/**
	 * Enumeration a utilise pour Tagger le debut et la fin de l'appel a chaque
	 * methode
	 * 
	 * @author Morad
	 *
